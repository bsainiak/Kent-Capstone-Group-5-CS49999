//This code should be ran on the backend server for security reasons
//Code created with the help from PayPal Tutorial
...
//Port used for example server functionality
...
//Create order function called when the PayPal button is presed
//Creates a JSON object to handle storing the price
...
//Once the user clicks pay now sends a request to paypal using the order ID and moves the money from the buyer to your account
...
//Sends the client ID and secret to OAuth2.0
