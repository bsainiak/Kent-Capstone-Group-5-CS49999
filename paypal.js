...
var client_id = "AS4qdkVEH0PROYKitc6h81kSMvbcHR1xo2h1FPwRuZ48Mlc5dlNGmt7vJyBAB_7Ut3ieJQVcjlxkzxqS";
var currency = "USD";
var intent = "capture";
...
.then(() =>
{
    ...
    var alerts = document.getElementById("alerts");
    var paypal_buttons = paypal.Buttons( // https://developer.paypal.com/sdk/js/reference
        {
            ...
            createOrder: function(data, actions) //https://developer.paypal.com/docs/api/orders/v2/#orders_create
            {
                return fetch("/create_order", // Use relative path
                {
                    ...
                    body: JSON.stringify({ "intent": intent, "imageId": selectedImageData.id })
                })
            ...
            onApprove: function(data, actions)
            {
                ...
                .then((order_details) =>
                {
                    ...
                    var downloadUrl = selectedImageData.filePath;
                    var imageName = downloadUrl.split('/').pop(); 
